...
namespace DotNetNinja.Templates.Mvc.Tests.Controllers
{
    public class ErrorControllerTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ErrorController(null));
        }
        ...
        {
            // Arrange
            var controller = _mocks.Create<ErrorController>();
            ...
            view.AssertIsDefaultViewForAction<ErrorController>(c=>c.Index());
        }
    }
}